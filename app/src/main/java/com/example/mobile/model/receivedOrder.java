...
public class receivedOrder {
    ...
    public receivedOrder(int id, String orderdate, String totalprice, com.example.mobile.model.account account, com.example.mobile.model.orderStatus orderStatus, com.example.mobile.model.bill bill, com.example.mobile.model.checkout checkout, List<item> items) {
        this.id = id;
